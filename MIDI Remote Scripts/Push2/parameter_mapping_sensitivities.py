...
# File: parameter_mapping_sensitivities.pyc (Python 2.5)
...
PARAMETER_SENSITIVITIES = {
    'Analog': {
        'OSC1 Octave': {
            DEFAULT_SENSITIVITY_KEY: 0.1 },
        'OSC2 Octave': {
            DEFAULT_SENSITIVITY_KEY: 0.1 },
        'OSC1 Semi': {
            DEFAULT_SENSITIVITY_KEY: 0.5 },
        'OSC1 Detune': {
            DEFAULT_SENSITIVITY_KEY: 0.5 },
        'OSC2 Semi': {
            DEFAULT_SENSITIVITY_KEY: 0.5 },
    ...
    'OriginalSimpler': {
        'Zoom': {
            DEFAULT_SENSITIVITY_KEY: 1 },
        'Mode': {
            DEFAULT_SENSITIVITY_KEY: 0.5 },
        'Playback': {
            DEFAULT_SENSITIVITY_KEY: 0.5 },
        'Start': {
            DEFAULT_SENSITIVITY_KEY: 0.2 },
        'End': {
            DEFAULT_SENSITIVITY_KEY: 0.2 },
        'Sensitivity': {
            DEFAULT_SENSITIVITY_KEY: 0.5 },
