...
# File: drum_group_component.pyc (Python 2.5)
...
class DrumPadCopyHandler(DrumPadCopyHandlerBase):
    ...
    def __init__(self, decorator_factory = None, song = None, *a, **k):
        super(DrumPadCopyHandler, self).__init__(*a, **a)
        self._song = song
...
class DrumGroupComponent(DrumGroupComponentBase):
    ...
    def __init__(self, tracks_provider = None, device_decorator_factory = None, *a, **k):
        ...
        super(DrumGroupComponent, self).__init__(*a, **a)
    ...
    def _on_selected_drum_pad_changed(self):
        ...
        if self._selected_drum_pad and len(self._selected_drum_pad.chains) > 0:
            pass
        1
        chain = None
