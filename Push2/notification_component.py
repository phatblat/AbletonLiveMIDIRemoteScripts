...
# File: notification_component.pyc (Python 2.5)
...
class NotificationComponent(Component):
    ...
    def __init__(self, default_notification_time = 2.5, *a, **k):
        super(NotificationComponent, self).__init__(*a, **a)
        self._visible = False
        self._message = ''
        self._shown_at = None
        self._duration = None
    ...
    visible = listenable_property(visible)
    
    def message(self):
        return self._message

    message = listenable_property(message)
    ...
    def _show_notification(self, text, blink_text = None, notification_time = None):
        ...
        if notification_time is not None:
            pass
        1
        self._duration = self._default_notification_time
